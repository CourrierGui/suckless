...
void setcert(Client* c, const char* uri) {
...
int main(int argc, char** argv) {
  ...
  ARGBEGIN {
    ...
    case 'u':
      ...
      break;
    case 'v':
      die("surf-"PACKAGE_VERSION", see LICENSE for © details\n");
    case 'w':
      showxid = 1;
      break;
    case 'x':
